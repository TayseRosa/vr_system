    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">            
                <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Lista</a>
                <a class="collapse-item" href="index.php?pag=alunos&funcao=novo"> Novo</a>
            </div>
        </div>
    </li>
...
<footer>
    ...
    <div class="footerCustom">
        <p>Todos os direitos reservados - <a href="www.rotulagem.com.br" target="_blank"> www.rotulagem.com.br</a> - <?php echo Date('Y')?> - <?php echo "Versão ". $versao; ?>
        </p>
    </div>
</footer>
